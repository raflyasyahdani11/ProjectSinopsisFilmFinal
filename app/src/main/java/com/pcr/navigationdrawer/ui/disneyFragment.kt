...
import kotlinx.android.synthetic.main.film_disney.*
...
class disneyFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.film_disney, container, false)
    }
    ...
    private fun setupRecyclerView() {
        ...
        val url = "${Constant.BASE_URL}/film?kategori=disney"
