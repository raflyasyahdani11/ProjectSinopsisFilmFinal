...
import kotlinx.android.synthetic.main.film_action.*
...
class actionFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.film_action, container, false)
    }
    ...
    private fun setupRecyclerView() {
        ...
        val url = "${Constant.BASE_URL}/film?kategori=action"
