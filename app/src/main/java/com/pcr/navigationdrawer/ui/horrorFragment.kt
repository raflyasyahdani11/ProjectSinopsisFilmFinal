...
class horrorFragment : Fragment(R.layout.film_horror) {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.film_horror, container, false)
    }
    ...
    private fun setupRecyclerView() {
        ...
        val url = "${Constant.BASE_URL}/film?kategori=horror"
