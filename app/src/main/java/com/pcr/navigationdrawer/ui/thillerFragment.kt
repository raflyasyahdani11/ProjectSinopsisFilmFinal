...
import kotlinx.android.synthetic.main.film_thiller.*

class thillerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.film_thiller, container, false)
    }
    ...
    private fun setupRecyclerView() {
        ...
        val url = "${Constant.BASE_URL}/film?kategori=thiller"
